...
def reward_func_generator(beta_list, threshold):
    def reward(time_add,time_out,salary,direct_distance):
        if time_add <= threshold:
            r = beta_list[0] + beta_list[1] * direct_distance - beta_list[2] * salary - beta_list[3] * time_out - beta_list[4] * time_add
        else:
            r = beta_list[0] + beta_list[1] * direct_distance - beta_list[2] * salary - beta_list[3] * time_out - beta_list[4] * time_add - beta_list[5] * (time_add - threshold)
        return r
    return reward
